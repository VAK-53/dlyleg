-file("/home/vak/kerl/24.3/lib/parsetools-2.3.2/include/leexinc.hrl", 0).
...
-file("src/dot_lexer.xrl", 25).

extract_string(Chars) ->
    lists:sublist(Chars,2, length(Chars) -2).

-file("/home/vak/kerl/24.3/lib/parsetools-2.3.2/include/leexinc.hrl", 14).
...
yystate(25, [10|Ics], Line, Tlen, _, _) ->
    yystate(25, Ics, Line+1, Tlen+1, 7, Tlen);
...
yystate(22, [103|Ics], Line, Tlen, Action, Alen) ->
...
yystate(22, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 99 ->
    yystate(17, Ics, Line, Tlen+1, Action, Alen);
yystate(22, [C|Ics], Line, Tlen, Action, Alen) when C >= 104, C =< 109 ->
    yystate(17, Ics, Line, Tlen+1, Action, Alen);
yystate(22, [C|Ics], Line, Tlen, Action, Alen) when C >= 111, C =< 114 ->
    yystate(17, Ics, Line, Tlen+1, Action, Alen);
yystate(22, [C|Ics], Line, Tlen, Action, Alen) when C >= 116, C =< 122 ->
    yystate(17, Ics, Line, Tlen+1, Action, Alen);
...
yystate(21, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 33 ->
    yystate(21, Ics, Line, Tlen+1, Action, Alen);
yystate(21, [C|Ics], Line, Tlen, Action, Alen) when C >= 35 ->
    yystate(21, Ics, Line, Tlen+1, Action, Alen);
...
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 102 ->
    yystate(17, Ics, Line, Tlen+1, 2, Tlen);
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 104, C =< 122 ->
    yystate(17, Ics, Line, Tlen+1, 2, Tlen);
...
-file("src/dot_lexer.xrl", 12).
yyaction_0(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_1/1}).
-file("src/dot_lexer.xrl", 14).
yyaction_1(TokenLine) ->
     { token, { op, TokenLine } } .

-compile({inline,yyaction_2/2}).
-file("src/dot_lexer.xrl", 15).
yyaction_2(TokenChars, TokenLine) ->
     { token, { word, TokenLine, TokenChars } } .

-compile({inline,yyaction_3/2}).
-file("src/dot_lexer.xrl", 16).
yyaction_3(TokenChars, TokenLine) ->
     { token, { float, TokenLine, list_to_float (TokenChars) } } .

-compile({inline,yyaction_4/2}).
-file("src/dot_lexer.xrl", 17).
yyaction_4(TokenChars, TokenLine) ->
     { token, { int, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_5/2}).
-file("src/dot_lexer.xrl", 18).
yyaction_5(TokenChars, TokenLine) ->
     { token, { string, TokenLine, extract_string (TokenChars) } } .

-compile({inline,yyaction_6/2}).
-file("src/dot_lexer.xrl", 19).
yyaction_6(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_7/0}).
-file("src/dot_lexer.xrl", 20).
yyaction_7() ->
     skip_token .

-compile({inline,yyaction_8/0}).
-file("src/dot_lexer.xrl", 21).
yyaction_8() ->
     skip_token .

-file("/home/vak/kerl/24.3/lib/parsetools-2.3.2/include/leexinc.hrl", 313).
